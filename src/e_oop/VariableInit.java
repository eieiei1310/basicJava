 ...
 * */
	...
	VariableInit(){
		/*for(int i = 1; i <= 100; i ++){
			this.var += i;
		*/
		this(100); //this(), ()안에 들어가는 파라미터의 개수와 타입을 보고 this 가 어떤 생성자를 가르키는지 판단한다 (오버로딩)
		
		//this() : 생성자에서 다른 생성자를 호출할 때 사용한다.
		//this()이전의 코드가 의미 없는 코드가 될 수 있기 때문에 this()는 생성자의 첫 줄에서만 사용할 수 있다.
		}
